...
export interface Repository {
  ...
  diffWith: ((ref: string) => Promise<Change[]>) & ((ref: string, path: string) => Promise<string>)
  diffIndexWithHEAD: (() => Promise<Change[]>) & ((path: string) => Promise<string>)
  diffIndexWith: ((ref: string) => Promise<Change[]>) & ((ref: string, path: string) => Promise<string>)
  diffBlobs: (object1: string, object2: string) => Promise<string>
  diffBetween: ((ref1: string, ref2: string) => Promise<Change[]>) & ((ref1: string, ref2: string, path: string) => Promise<string>)
