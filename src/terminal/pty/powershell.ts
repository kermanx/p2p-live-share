...
// Based on https://github.com/microsoft/vscode/blob/main/src/vs/base/node/powershell.ts

import * as os from 'node:os'
import * as path from 'node:path'
import process from 'node:process'
import * as pfs from './utils.js'
...
function getProgramFilesPath(
  { useAlternateBitness = false }: { useAlternateBitness?: boolean } = {},
): string | null {
...
async function findPSCoreWindowsInstallation(
  ...
  { useAlternateBitness?: boolean, findPreview?: boolean } = {},
