// Based on https://github.com/microsoft/vscode/blob/main/src/vs/platform/terminal/common/environmentVariable.ts

import type { IProcessEnvironment, IWorkspaceFolderData } from './utils.js'
